...
import { FormEditUnidad } from '../views/FormEditUnidad';
import { eliminarUnidad } from '../services/unidades-service';

export const EditUnidad = ({unidad}) => {
  ...
  const handleDelete = async () => {
    setDeleting(true);
    const result = await eliminarUnidad(unidadData._id)
  ...
  return (
    ...
    <Modal show={show} onHide={handleClose} size="lg">
      <FormEditUnidad handleClose={handleClose} unidad={unidadData} setData={setUnidadData} />
    </Modal>

    {/*Modal Eliminar*/}
    <Modal show={showEliminar} onHide={handleCloseEliminar}>
      <Modal.Header closeButton>
        <Modal.Title>Eliminar Unidad Técnica</Modal.Title>
      </Modal.Header>
      <Modal.Body>¿Desea eliminar este Unidad Técnica? Esta accion no puede revertirse.</Modal.Body>
      <Modal.Footer>
