...
import { FormEditREDIAN } from '../views/FormEditREDIAN';
import { eliminarREDIAN } from '../services/redian-service';

export const EditREDIAN = ({valor}) => {
  ...
  const handleDelete = async () => {
    setDeleting(true);
    const result = await eliminarREDIAN(valorData._id)
  ...
  return (
    ...
    <Modal show={show} onHide={handleClose} size="lg">
      <FormEditREDIAN handleClose={handleClose} valor={valorData} setData={setValorData} />
    </Modal>

    {/*Modal Eliminar*/}
    <Modal show={showEliminar} onHide={handleCloseEliminar}>
      <Modal.Header closeButton>
        <Modal.Title>Eliminar Tablero</Modal.Title>
      </Modal.Header>
      <Modal.Body>¿Desea eliminar este Tablero? Esta accion no puede revertirse.</Modal.Body>
      <Modal.Footer>
