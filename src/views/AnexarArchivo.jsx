...
import { publicarArchivosNoticia } from "../services/archivos-service.js";
import { Button, Card, Form, Spinner } from 'react-bootstrap';
import { RefetchContext } from "../contexts/RefetchContext.js";
import { ToastContext } from "../contexts/ToastContext.js";

export const AnexarArchivo = ({handleClose, noticia}) => {
  //Contexts
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setCharging(true)
    const result = await publicarArchivosNoticia(values.multimedia, values.id)
    setCorrect(result)
    handleClose()
    setCharging(false)
  };
