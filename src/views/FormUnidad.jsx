...
import { sendUnidad } from "../services/unidades-service.js";

export const FormUnidad = ({handleClose, handleAddUnidad}) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setCharging(true)
    const result = await sendUnidad(values)
    setCorrect(result)
    handleAddUnidad(result)
    handleClose()
    setCharging(false)
  };
